...
class CampaignSender extends EventEmitter {
    ...
    async processQueue(campaignId) {
        ...
        try {
            ...
            // Trigger webhook
            sendWebhook('message.sent', sessionId, { destination: jid, content: messageData });
            ...
            sendWebhook('message.error', sessionId, { destination: recipient.number, error: error.message });
